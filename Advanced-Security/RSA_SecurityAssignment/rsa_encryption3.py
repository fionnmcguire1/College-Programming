...
def generating_keys(prime1,prime2):
    ...
    while check =='true':
        if (i*encryption_key)%fie_function ==1:
            ...
            i+=1
        """    
        i = fie_function/encryption_key
        
        while round(i%fie_function) != 1:
            i*2
            print(i)
...
def generate_primes(the_number):

    print(the_number)

    bits = int(the_number.get())
    if bit_number == None:
        bit_number = 10
...
"""
gui = Tk()
gui.geometry('450x450+820+20')
gui.title("RSA Encryptor")
"""
global bits
global bit_number
"""
...
bit_label = Label(gui,text = 'Enter Bit number: ').place(x = 10, y = 10)
input_value = Entry(gui).place(x = 280, y = 10)
input_value.insert(10, "mike")


"""
if bit_number != None:
    bit_number1 = int(bit_number)
    generating_keys = Button(gui,text = 'Generate Keys ', command = lambda: generate_primes(bit_number1)).place(x = 280, y = 40)
else:
    generating_keys = Button(gui,text = 'Generate Keys ', command = lambda: generate_primes(bit_number=10)).place(x = 280, y = 40)

"""
generating_keys = Button(gui,text = 'Generate Keys ', command = lambda: generate_primes(bit_number.get())).place(x = 280, y = 40)

"""
text_label = Label(gui,text = 'Enter Text for endryption or decryption: ').place(x = 10, y = 150)
text = Entry(gui).place(x = 280, y = 150)
encrypt_button = Button(gui,text = 'Encrypt', command = rsa_encryption).place(x = 30, y = 200)
decrypt_button = Button(gui,text = 'Decrypt', command = rsa_decryption).place(x = 180, y = 200)
browse_button = Button(gui,text = 'Browse').place(x = 330, y = 200)
"""
