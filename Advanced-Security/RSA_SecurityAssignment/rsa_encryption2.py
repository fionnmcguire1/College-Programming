...
global bit_number
"""
bit_number=StringVar()



bit_label = Label(gui,text = 'Enter Bit number: ').place(x = 10, y = 10)
bit_number = Entry(gui, textvariable=bit_number).place(x = 280, y = 10)
"""
if bit_number != None:
...
"""
generating_keys = Button(gui,text = 'Generate Keys ', command = lambda: generate_primes()).place(x = 280, y = 40)
